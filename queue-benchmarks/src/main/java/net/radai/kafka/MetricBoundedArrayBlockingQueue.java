...
public class MetricBoundedArrayBlockingQueue<E> extends AbstractQueue<E> implements BlockingQueue<E>, Serializable {
   ...
   */
  private void enqueue(E x, long measurement) {
  ...
  public long remainingMetricCapacity() {
    final ReentrantLock lock = this.lock;
    lock.lock();
    try {
      return metricBound - metricSize;
    } finally {
      lock.unlock();
    }
  }
